...
| `elasticsearch.sysctlImage.enabled`          | Enable kernel settings modifier image                                                                                                                                                                                                                                   | `true`                        |
| `elasticsearch.sysctlImage.registry`         | Elasticsearch sysctlImage registry                                                                                                                                                                                                                                      | `docker.io`                   |
| `elasticsearch.sysctlImage.repository`       | Elasticsearch sysctlImage repository                                                                                                                                                                                                                                    | `bitnamilegacy/elasticsearch` |
